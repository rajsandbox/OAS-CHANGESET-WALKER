...
var getSchemaFromRef = function ($ref, schema) {
    var refPath = getPathFromRef($ref);
    if (refPath) {
        return cloneDeep_1(at_1(schema, [refPath])[0]);
    }
};
var isCyclic = function (object) {
    var keys = [];
    var stack = [];
...
var getChange = function (changeset, path) {
...
//# sourceMappingURL=changeset-operation.js.map

//# sourceMappingURL=index.js.map

var walk = function (schemaObj, contentType, options) {
    var schemas = [];
    var firstPathKey = '';
    var pathKey = '';
